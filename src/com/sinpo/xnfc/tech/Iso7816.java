...
public class Iso7816 {
	...
	public final static class Response extends Iso7816 {
		...
		public short getSw12() {
			...
			int n = d.length;
			short sw12 = (short) ((d[n - 2] << 8) | (0xFF & d[n - 1]));
			Log.d("getSw12", "" + sw12);
			return sw12;
		}
	...
	public final static class Tag {
		...
		public Response initPurchase(boolean isEP) {
			final byte[] cmd = {
					...
					(byte) 0x0B, // Lc
					(byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x11, (byte) 0x22, (byte) 0x33, (byte) 0x44,
					(byte) 0x55, (byte) 0x66, (byte) 0x0F, // Le
			};
